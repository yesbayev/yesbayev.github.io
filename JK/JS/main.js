...
//  .toLocaleString()   Куда нужно запихнуть этот метод?
...
// building2017.onclick = function () {
// 	this.style.fontSize = '36px';
// 	this.style.color = 'black';
// };

// building2018.onclick = function () {
// 	this.style.fontSize = '36px';
// 	this.style.color = 'black';
// };

// building2019.onclick = function () {
// 	this.style.fontSize = '36px';
// 	this.style.color = 'black';
// };


// function building2017() {
//     document.getElementById("building2017").classList.toggle('active');
// 	this.style.fontSize = '36px';
// 	this.style.color = 'black';
// }

// function building2018() {
//     document.getElementById("building2018").classList.toggle('active');
// }

// function building2019() {
//     document.getElementById("building2019").classList.toggle('active');
// }
